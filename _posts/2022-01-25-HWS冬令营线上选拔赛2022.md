...
start脚本跑起来本地qemu环境，上传gdbserver调试，发现正常gdb调试多进程的方法不能使用，看不见生成的子进程，如果在某个位置下断点，执行到断点时则会退出进程、断开连接

整体完成http的功能，设置了 flag.cgi 和 pwncgi.cgi 路由是需要身份验证后才能访问的，game.cgi 和其他一些不需要
...
#5:100110 :000110101001110100111000110100011010100111


#5:0110001:011000101001110100111000110100011010100111

#8:0001001:011000100010010100111000110100011010100111

#5:0111001:011000100010010111001000110100011010100111

#5:0110001:011000100010010111001011000100011010100111

#9:0001011:011000100010010111001011000100010110100111

#2:0011011:011000100010010111001011000100010110011011
